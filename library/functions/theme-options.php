...
/* ------------------------------------ */
	'settings'        => array(
		...
		// General: Upload CV Form
		array(
			'id'		=> 'postcv-form',
			'label'		=> 'Upload CV Form',
			'desc'		=> 'Select CV form page',
			'type'		=> 'page-select',
			'section'	=> 'general'
		),
		...
		array(
			...
			'desc'		=> 'Select page which present message in footer',
			'type'		=> 'page-select',
			'section'	=> 'footer'
		),
		// Footer: Profile highlight
		array(
			'id'		=> 'profile-highlight',
			'label'		=> 'Profile Highlight',
			'desc'		=> 'Select page which present short description of company profile',
			'type'		=> 'page-select',
			'section'	=> 'footer'
		),
		// Footer: Contact info
		array(
			'id'		=> 'contact-info',
			'label'		=> 'Contact info',
			'desc'		=> 'Select page which present quick contact information',
			'type'		=> 'page-select',
			'section'	=> 'footer'
		),
		// Footer: Copyright
