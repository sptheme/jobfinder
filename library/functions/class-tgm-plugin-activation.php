    ...
    class TGMPA_List_Table extends WP_List_Table {
        ...
        protected function _gather_plugin_data() {
            ...
            foreach ( TGM_Plugin_Activation::$instance->plugins as $plugin ) {
                ...
                if ( isset($plugin['method']) && ($plugin['method'] == 'buy') ) {
                    $table_data[$i]['type'] = __( 'Premium Plugin', 'tgmpa' );
                    $table_data[$i]['plugin'] = '<strong><a href="' . $plugin['external_url'] . '">'.$plugin['name'].'</a></strong>';
                }
        ...
        public function column_plugin( $item ) {
            ...
            if ( ! isset( $installed_plugins[$item['file_path']] ) ) {
                if ($item['slug'] == 'wpml') {
                    ...
                    $actions = array(
                        'install' => '<a href="http://wpml.org/?aid=63524&affiliate_key=wP53KkuDHd0l">Buy</a>',
                    );
